...
print(txtFileData.readline()) # FirstLine -> # /**
print(txtFileData.readline()) # SecondLine -> # * @author Rajat Verma
print(txtFileData.readline()) # ThirdLine -> # * https://www.linkedin.com/in/rajat-v-3b0685128/
